...
class Generator(object):
    def __init__(self, file_name, df = np.nan, top = 100):
    ...
    def read(self):
        ...
        dataset_name = self.file_name + 'preprocessed.csv'
    ...
    def maxmatrix(self):
        ...
        #simdf.to_csv('train_pair.csv')
        print('Finish Generating Pair Matrix')
        return simdf


# Generator('freesolv')
# print('Finish Free Energy Dataset')
# Generator('delaney')
# print('Finish ESOL Dataset')
# Generator('lipo')
# print('Finish Lipo Dataset')
# Generator('qm7')
# print('Finish QM7 Dataset')
# Generator('qm8')
# print('Finish QM8 Dataset')
# Generator('qm9')
# print('Finish QM9 Dataset')
